"""
Django settings for project e_shop.
...
# See https://docs.djangoproject.com/en/4.0/ref/settings/#force-script-name
...
CORS_ORIGIN_REGEX_WHITELIST = ["%r" % value for value in getenv("CORS_ORIGIN_REGEX_WHITELIST", type=list, default=[])]
...
APP_VERSION = "1.0.0"
APP_NAME = "e_shop"
APP_DESCRIPTION = "A RESTfull API for project e_shop"
